...
#ifndef __nox_lcm_MapPt_hpp__
#define __nox_lcm_MapPt_hpp__
...
int MapPt::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int MapPt::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int MapPt::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t MapPt::getHash()
{
    static int64_t hash = _computeHash(NULL);
    return hash;
}

const char* MapPt::getTypeName()
{
    return "MapPt";
}

int MapPt::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int MapPt::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int MapPt::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t MapPt::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0xbfa745904c4b4dd8LL;
